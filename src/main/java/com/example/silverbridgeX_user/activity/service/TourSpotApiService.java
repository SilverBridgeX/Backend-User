...
public class TourSpotApiService {
    ...
    public void fetchAndSaveTourSpotData() throws Exception {
        ...
        if (items != null && items.isArray()) {
            System.out.println("가져온 관광지 개수: " + items.size());
